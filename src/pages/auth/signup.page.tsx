  ...
  export function SignUpPage() {
    ...
    return (
      <form onSubmit={formik.handleSubmit} className="mt-5 flex flex-col justify-center items-center">
        <Card className="w-full md:w-96 mt-5 bg-test-200">
          <CardBody className="flex flex-col gap-4 my-8">
            <div className="flex gap-4 items-center justify-center">
              <BackButton extraClass="absolute left-5"/>
      ...
      <Button type="submit" className="rounded-[15px] custom-shadow h-[75px] bg-amber-custom text-black" size="md" disabled={mutation.isPending || !termsAccepted || formik.values.email == '' || formik.values.password == '' || formik.values.password !== confirmPassword}>
