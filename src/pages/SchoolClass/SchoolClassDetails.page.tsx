...
export default function SchoolClasseDetailsPage() {
    ...
    function isDarkColor(hex :string) : boolean {
        ...
        return luminance < 128; // You can adjust threshold
    }
            ...
            <Wrapper extraClass="flex flex-col gap-5">
                ...
                >
                    <div className="w-full flex gap-3 justify-around items-center">
                        <BackButton />
                        <h1 className={isDarkColor(schoolClass.color) ? "text-white" : "text-black"}>{schoolClass.name}</h1>
                    ...
                    <Typography as="p" className={`${isDarkColor(schoolClass.color) ? "text-white" : "text-black"} text-xl font-semibold`}>Voilà les élèves de {schoolClass.name} !</Typography>
