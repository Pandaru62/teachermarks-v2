...
const originalDescription = report?.description ?? " ";
    ...
    return(
        <form onSubmit={formik.handleSubmit} className="flex flex-col gap-2 mb-4">
            ...
            />
            <span className={formik.values.description.length > 400 ? "text-red-600 text-right" : "text-gray-600 text-right"}>
                Nombre de caractères : { formik.values.description.length}/400
            </span>
            ...
            <div className="w-full flex justify-center gap-2 mt-2">
                ...
                <Button size="sm" type="submit" color="green" className="flex items-center gap-1" disabled={formik.values.description === originalDescription}>
